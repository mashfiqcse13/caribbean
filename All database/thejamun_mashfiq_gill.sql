...
--
-- Host: localhost:3306
-- Generation Time: Apr 19, 2016 at 06:13 PM
...
--
-- Database: `thejamun_mashfiq_gill`
--
...
INSERT INTO `tbl_contact` (`id`, `first_name`, `last_name`, `name`, `artistbandname`, `type_of_file`, `title_of_work`, `genre`, `email`, `company`, `job_title`, `query_subject`, `query`, `file_attached`, `join_date`, `join_time`, `created`) VALUES
...
(15, 'Leroy', 'Wilkins', 'Leroy Wilkins', 'Mr Lee G', 'Photo', 'My Lady', 'Dancehall', 'vano31@netzero.net', 'Chris Production', 'Manager', 'New music', 'Pic', '', '2015-04-27', '01:14:01 PM', '2015-04-27 01:14:01'),
...
(22, '', '', '', '', '', '', '', 'mashfiqnahid@gmail.com', 'none com', 'Athlete', 'a;sljflksdjf', 'asdfasfasdfasdf', 'uploadcontact/newname2016-04-19-07-28-09.mp3', '2016-04-19', '07:28:09 AM', '2016-04-19 07:28:09'),
(23, '', '', '', '', '', '', '', 'mashfiqnahid@gmail.com', 'none com', 'Athlete', 'a;sljflksdjf', 'asdfasfasdfasdf', 'uploadcontact/newname2016-04-19-07-59-41.mp4', '2016-04-19', '07:59:41 AM', '2016-04-19 07:59:41');
...
CREATE TABLE IF NOT EXISTS `tbl_msg` (
  ...
  `view_status` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `from_id` (`from_id`,`to_id`,`send_date`)
...
INSERT INTO `tbl_orders` (`id`, `order_date`, `uid`, `seller_id`, `p_id`, `p_amt`, `shipping_amt`, `total_amt`, `order_status`, `payment_status`, `buyer_feedback`) VALUES
...
(6, '2014-10-28', 4, 9, 2, 19.00, 7.00, 26.00, 0, 0, 'Nice Product'),
...
(16, 10, '', '16.jpg', 1, '2016-04-19 02:00:20', '2016-04-18 20:00:20'),
(17, 10, '', '17.jpg', 1, '2016-04-19 02:00:45', '2016-04-18 20:00:45'),
(18, 10, '', '18.jpg', 1, '2016-04-19 02:01:03', '2016-04-18 20:01:03');
...
CREATE TABLE IF NOT EXISTS `tbl_user_activity` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`,`activity_time`)
...
(135, 10, 'Torie Added/Changed Profile Picture ', '2016-04-18 20:00:20'),
(136, 10, 'Torie Added/Changed Profile Picture ', '2016-04-18 20:00:44'),
(137, 10, 'Torie Added/Changed Profile Picture ', '2016-04-18 20:01:03');
