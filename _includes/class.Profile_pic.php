...
class Profile_pic {
    ...
    private $destination_url_after_processing;
    private $db;
    ...
    function __construct($user_id, $user_type) {
        ...
        $this->destination_url_after_processing = 'update_profile_photo.php' . user_idd;
    }
    ...
    function update($form_FILES_ARRAY, $go_to_cropping = FALSE, $upload_and_update_propic = FALSE) {
        ...
        if (!in_array($filetype, $whitelist)) {
            ...
            if ($go_to_cropping == 1) {
                $this->destination_url_after_processing = "media_img_cropper.php?photoid=" . $db->last_insert_id('tbl_profile_images') . user_idd1;
            }
