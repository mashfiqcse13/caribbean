...
//function
     ...
     */
    function saveData() {
        $_SESSION['securimage_code_value2'] = strtolower($this->code);
    ...
    function validate() {
        ...
        if (isset($_SESSION['securimage_code_value2']) && trim($_SESSION['securimage_code_value2']) != '') {
            if ($this->isCodeExpired($_SESSION['securimage_code_ctime']) == false) {
                $code = $_SESSION['securimage_code_value2'];
            }
        ...
        if ($code != '') {
            if ($code == $code_entered) {
                ...
                $_SESSION['securimage_code_value2'] = '';
     ...
     */
    function getCode() {
        if (isset($_SESSION['securimage_code_value2']) && !empty($_SESSION['securimage_code_value2'])) {
            return strtolower($_SESSION['securimage_code_value2']);
        } else {
    ...
    function saveCodeToDatabase() {
        ...
        if ($this->use_sqlite_db && $this->sqlite_handle !== false) {
            $ip = $this->getIPHash();
            $time = time();
            $code = $_SESSION['securimage_code_value2']; // hash code for security - if cookies are disabled the session still exists at this point
