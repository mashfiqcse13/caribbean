...
$img->image_bg_color = new Securimage_Color("#ECECEC");
//$img->use_transparent_text = true;
//$img->text_transparency_percentage = 75; // 100 = completely transparent
$img->num_lines = 0;
$img->image_signature = '';
//$img->text_color = new Securimage_Color("#714A8F");
$img->text_color = new Securimage_Color("#99CC33");
$img->line_color = new Securimage_Color("#ffffff");
//$img->show('../img/new.png');
