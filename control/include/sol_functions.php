...
//	Functions for image
//	Date: 24-02-2009
// 	Instructions: create_thumb($source,$destination,$max_size);
//	pass the size as 100, its for the ration of the new image
/////////////////////////////////////////////////////////////
function create_thumb($source, $destination, $size = "100") {
    //echo "sdsd";
    //echo $path;
    if (file_exists($source)) {
        ...
        $thumb = new my_thumbnail($source); // generate image_file, set filename to resize
        ...
        $thumb->save($destination);  // save your thumbnail to file
//				echo "saved";
        //	}
    } else {
        return false;
