(function (aP, aN) {
    ...
    function an(e) {
        if (!cp[e]) {
            var d = aJ("<" + e + ">").appendTo("body"), f = d.css("display");
            d.remove();
            if (f === "none" || f === "") {
                f = "block";
            }
    ...
    function cJ(v, u, t, s, r, q) {
        ...
        var p = v[r], o = 0, n = p ? p.length : 0, m = v === cP, b;
        for (; o < n && (m || !b); o++) {
    ...
    function cK(b) {
        return function (a, p) {
            ...
            if (aJ.isFunction(p)) {
                var o = a.toLowerCase().split(cV), n = 0, m = o.length, l, k, d;
                for (; n < m; n++) {
    ...
    function aU(g, d, j) {
        var i = d === "width" ? a3 : a1, h = d === "width" ? g.offsetWidth : g.offsetHeight;
        if (j === "border") {
            return h;
        }
        aJ.each(i, function () {
    ...
    function b9(d, c) {
        c.src ? aJ.ajax({url: c.src, async: !1, dataType: "script"}) : aJ.globalEval(c.text || c.textContent || c.innerHTML || ""), c.parentNode && c.parentNode.removeChild(c);
    }
    ...
    function aY(r, q) {
        if (q.nodeType === 1 && aJ.hasData(r)) {
            var p = aJ.expando, o = aJ.data(r), n = aJ.data(q, o);
            if (o = o[p]) {
                var m = o.events;
                n = n[p] = aJ.extend({}, o);
                if (m) {
    ...
    function cv(J) {
        var I, H, G, F, E, D, C, B, A, z, y, x, w, v = [], u = [], p = aJ._data(this, "events");
    ...
    var aL = aP.document, aJ = function () {
        function J() {
            if (!bl.isReady) {
                try {
        ...
        bl.fn = bl.prototype = {constructor: bl, init: function (d, p, o) {
            ...
            return o;
                ...
                if (f && bg.test(f)) {
                    var d = aL.head || aL.getElementsByTagName("head")[0] || aL.documentElement, g = aL.createElement("script");
                ...
                var o, n = 0, m = d.length, l = m === aN || bl.isFunction(d);
                if (p) {
                    if (l) {
                        for (o in d) {
                            if (q.apply(d[o], p) === !1) {
                ...
                bl.extend(d, {then: function (e, i) {
                        d.done(e).fail(i);
                        return this;
                    }, fail: h.done, rejectWith: h.resolveWith, reject: h.resolve, isRejected: h.isResolved, promise: function (e) {
                        if (e == null) {
                            if (g) {
                                return g;
                            }
                ...
                var d = arguments.length, n = d <= 1 && i && bl.isFunction(i.promise) ? i : bl.Deferred(), m = n.promise();
                if (d > 1) {
                    var l = Q.call(arguments, 0), k = d, j = function (e) {
                        return function (f) {
    ...
    (function () {
        ...
        var u = v.getElementsByTagName("*"), t = v.getElementsByTagName("a")[0], s = aL.createElement("select"), r = s.appendChild(aL.createElement("option")), q = v.getElementsByTagName("input")[0];
        if (u && u.length && t) {
            aJ.support = {leadingWhitespace: v.firstChild.nodeType === 3, tbody: !v.getElementsByTagName("tbody").length, htmlSerialize: !!v.getElementsByTagName("link").length, style: /red/.test(t.getAttribute("style")), hrefNormalized: t.getAttribute("href") === "/a", opacity: /^0.55$/.test(t.style.opacity), cssFloat: !!t.style.cssFloat, checkOn: q.value === "on", optSelected: r.selected, deleteExpando: !0, optDisabled: !1, checkClone: !1, noCloneEvent: !0, noCloneChecked: !0, boxModel: null, inlineBlockNeedsLayout: !1, shrinkWrapBlocks: !1, reliableHiddenOffsets: !0}, q.checked = !0, aJ.support.noCloneChecked = q.cloneNode(!0).checked, s.disabled = !0, aJ.support.optDisabled = !r.disabled;
            var p = null;
            aJ.support.scriptEval = function () {
                if (p === null) {
                    var h = aL.documentElement, k = aL.createElement("script"), j = "script" + aJ.now();
                    try {
            ...
            c.appendChild(v.firstChild), aJ.support.checkClone = c.cloneNode(!0).cloneNode(!0).lastChild.checked, aJ(function () {
                var g = aL.createElement("div"), f = aL.getElementsByTagName("body")[0];
                if (f) {
    ...
    var aH = /^(?:\{.*\}|\[.*\])$/;
    aJ.extend({cache: {}, uuid: 0, expando: "jQuery" + (aJ.fn.jquery + Math.random()).replace(/\D/g, ""), noData: {embed: !0, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: !0}, hasData: function (b) {
            b = b.nodeType ? aJ.cache[b[aJ.expando]] : b[aJ.expando];
            return !!b && !aD(b);
        }, data: function (t, s, r, q) {
            if (aJ.acceptData(t)) {
                var p = aJ.expando, o = typeof s === "string", n, m = t.nodeType, d = m ? aJ.cache : t, b = m ? t[aJ.expando] : t[aJ.expando] && aJ.expando;
            ...
            if (aJ.acceptData(r)) {
                var o = aJ.expando, n = r.nodeType, m = n ? aJ.cache : r, g = n ? r[aJ.expando] : aJ.expando;
                if (!m[g]) {
                    return;
                }
                if (q) {
            ...
            return !0;
        }}), aJ.fn.extend({data: function (b, p) {
            var o = null;
        ...
        }}), aJ.extend({queue: function (f, d, h) {
            if (f) {
                d = (d || "fx") + "queue";
                var g = aJ._data(f, d);
                if (!h) {
    ...
    var aB = /[\n\t\r]/g, az = /\s+/, ay = /\r/g, ax = /^(?:href|src|style)$/, aw = /^(?:button|input)$/i, av = /^(?:button|input|object|select|textarea)$/i, au = /^a(?:rea)?$/i, ar = /^(?:radio|checkbox)$/i;
    aJ.props = {"for": "htmlFor", "class": "className", readonly: "readOnly", maxlength: "maxLength", cellspacing: "cellSpacing", rowspan: "rowSpan", colspan: "colSpan", tabindex: "tabIndex", usemap: "useMap", frameborder: "frameBorder"}, aJ.fn.extend({attr: function (d, c) {
            ...
            return this.each(function () {
                if (h === "string") {
                    var i, e = 0, c = aJ(this), b = d, a = f.split(az);
                    while (i = a[e++]) {
        ...
        }}), aJ.extend({attrFn: {val: !0, css: !0, html: !0, text: !0, data: !0, width: !0, height: !0, offset: !0}, attr: function (t, s, r, q) {
            ...
            var n = t.nodeType !== 1 || !aJ.isXMLDoc(t), m = r !== aN;
            s = n && aJ.props[s] || s;
            if (t.nodeType === 1) {
                var l = ax.test(s);
    ...
    var ao = /\.(.*)$/, am = /^(?:textarea|input|select)$/i, al = /\./g, aj = / /g, ag = /[^\w\s.|`]/g, af = function (b) {
        return b.replace(ag, "\\$&");
    };
    aJ.event = {add: function (D, C, B, A) {
            if (D.nodeType !== 3 && D.nodeType !== 8) {
                ...
                var t, s = 0, d;
                while (t = C[s++]) {
                    x = y ? aJ.extend({}, y) : {handler: B, data: A}, t.indexOf(".") > -1 ? (d = t.split("."), t = d.shift(), x.namespace = d.slice(0).sort().join(".")) : (d = [], x.namespace = ""), x.type = t, x.guid || (x.guid = B.guid);
                    var b = v[t], a = aJ.event.special[t] || {};
                    if (!b) {
                        b = v[t] = [];
            ...
            if (L.nodeType !== 3 && L.nodeType !== 8) {
                J === !1 && (J = ae);
                var H, G, F, E, D = 0, C, B, A, z, y, x, v, u = aJ.hasData(L) && aJ._data(L), d = u && u.events;
                if (!u || !d) {
                    return;
                }
            ...
            if (!B.isPropagationStopped() && v) {
                ...
                if (!B.isDefaultPrevented()) {
                    var t, s = B.target, r = y.replace(ao, ""), p = aJ.nodeName(s, "a") && r === "click", d = aJ.event.special[r] || {};
            ...
            var w, v, u, t, s, r = [], q = aJ.makeArray(arguments);
            ...
            if (b.pageX == null && b.clientX != null) {
                var d = aL.documentElement, c = aL.body;
            ...
            return b;
        }, guid: 100000000, proxy: aJ.proxy, special: {ready: {setup: aJ.bindReady, teardown: aJ.noop}, live: {add: function (b) {
                    aJ.event.add(this, ct(b.origType, b.selector), aJ.extend({}, b, {handler: cv, guid: b.handler.guid}));
                }, remove: function (b) {
    ...
    }, aJ.Event.prototype = {preventDefault: function () {
    ...
    aJ.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (d, c) {
        aJ.event.special[d] = {setup: function (a) {
                aJ.event.add(this, c, a && a.selector ? ab : ac, d);
            }, teardown: function (b) {
                aJ.event.remove(this, c, b && b.selector ? ab : ac);
            }};
    }), aJ.support.submitBubbles || (aJ.event.special.submit = {setup: function (d, c) {
    ...
    if (!aJ.support.changeBubbles) {
        ...
        aJ.event.special.change = {filters: {focusout: cC, beforedeactivate: cC, click: function (e) {
    ...
    aL.addEventListener && aJ.each({focus: "focusin", blur: "focusout"}, function (e, d) {
        function f(b) {
            b = aJ.event.fix(b), b.type = d;
            return aJ.event.handle.call(this, b);
        }

        aJ.event.special[d] = {setup: function () {
    ...
    }), aJ.fn.extend({unbind: function (g, d) {
    ...
    aJ.each(["live", "die"], function (b, d) {
        aJ.fn[d] = function (D, C, B, A) {
            var z, y = 0, x, w, v, u = A || this.selector, t = A ? this : aJ(this.context);
            ...
            while ((z = D[y++]) != null) {
                ...
                if (d === "live") {
                    for (var p = 0, c = t.length; p < c; p++) {
                        aJ.event.add(t[p], "live." + ct(z, u), {data: C, selector: u, handler: B, origType: z, origHandler: B, preType: v});
                    }
                } else {
        ...
        var D = E.selectors = {order: ["ID", "NAME", "TAG"], match: {ID: /#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, CLASS: /\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/, ATTR: /\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/, TAG: /^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/, CHILD: /:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/, POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/, PSEUDO: /:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch: {}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {href: function (e) {
                    ...
                    var p = typeof i === "string", o = p && !F.test(i), n = p && !o;
                    o && (i = i.toLowerCase());
                    ...
                    var n = h[1], m = D.attrHandle[n] ? D.attrHandle[n](i) : i[n] != null ? i[n] : i.getAttribute(n), l = m + "", k = h[2], j = h[4];
        ...
        aL.documentElement.compareDocumentPosition ? x = function (f, e) {
            ...
            var f = aL.createElement("div"), h = "script" + (new Date).getTime(), g = aL.documentElement;
            ...
            var g = E, f = aL.createElement("div"), i = "__sizzle__";
                    ...
                    if (!N && !E.isXML(P)) {
                        ...
                        if (P.nodeType === 9) {
                            ...
                            if (P.nodeType === 1 && P.nodeName.toLowerCase() !== "object") {
                                var t = P, p = P.getAttribute("id"), l = p || i, k = P.parentNode, a = /^\s*[+~]/.test(Q);
            ...
            var g = aL.documentElement, f = g.matchesSelector || g.mozMatchesSelector || g.webkitMatchesSelector || g.msMatchesSelector, i = !1;
            try {
    ...
    var cr = /Until$/, cq = /^(?:parents|prevUntil|prevAll)/, co = /,/, cn = /^.[^:#\[\.,]*$/, cm = Array.prototype.slice, cl = aJ.expr.match.POS, ck = {children: !0, contents: !0, next: !0, prev: !0};
    aJ.fn.extend({find: function (i) {
            ...
            if (aJ.isArray(v)) {
                ...
                if (q && v.length) {
                    ...
                    while (q && q.ownerDocument && q !== u) {
                        for (o in n) {
                            p = n[o], (p.jquery ? p.index(q) > -1 : aJ(q).is(p)) && t.push({selector: o, elem: q, level: m});
                        }
                        q = q.parentNode, m++;
                    }
                }
            ...
            var h = typeof f === "string" ? aJ(f, d) : aJ.makeArray(f), g = aJ.merge(this.get(), h);
            return this.pushStack(ci(h[0]) || ci(g[0]) ? g : aJ.unique(g));
        }, andSelf: function () {
            return this.add(this.prevObject);
        }}), aJ.each({parent: function (d) {
            var c = d.parentNode;
        ...
        aJ.fn[d] = function (i, h) {
            var b = aJ.map(this, c, i), a = cm.call(arguments);
    ...
    }), aJ.extend({filter: function (e, d, f) {
            f && (e = ":not(" + e + ")");
    ...
    var b8 = / jQuery\d+="(?:\d+|null)"/g, b6 = /^\s+/, b4 = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, b2 = /<([\w:]+)/, b0 = /<tbody/i, a8 = /<|&#?\w+;/, a6 = /<(?:script|object|embed|option|style)/i, a4 = /checked\s*(?:[^=]|=\s*.checked.)/i, a2 = {option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], area: [1, "<map>", "</map>"], _default: [0, "", ""]};
    a2.optgroup = a2.option, a2.tbody = a2.tfoot = a2.colgroup = a2.caption = a2.thead, a2.th = a2.td, aJ.support.htmlSerialize || (a2._default = [1, "div<div>", "</div>"]), aJ.fn.extend({text: function (b) {
            if (aJ.isFunction(b)) {
                return this.each(function (a) {
                    var d = aJ(this);
            ...
            if (this[0]) {
                r = q && q.parentNode, aJ.support.parentNode && r && r.nodeType === 11 && r.childNodes.length === this.length ? u = {fragment: r} : u = aJ.buildFragment(x, this, p), s = u.fragment, s.childNodes.length === 1 ? t = s = s.firstChild : t = s.firstChild;
                if (t) {
    ...
    }, aJ.fragments = {}, aJ.each({appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith"}, function (d, c) {
        aJ.fn[d] = function (o) {
            var n = [], m = aJ(o), l = this.length === 1 && this[0].parentNode;
    ...
    }), aJ.extend({clone: function (i, d, n) {
            ...
            for (var w = 0, v; (v = B[w]) != null; w++) {
                ...
                if (typeof v !== "string" || a8.test(v)) {
                    if (typeof v === "string") {
                        v = v.replace(b4, "<$1></$2>");
                        var u = (b2.exec(v) || ["", ""])[1].toLowerCase(), t = a2[u] || a2._default, s = t[0], r = A.createElement("div");
                        r.innerHTML = t[1] + v + t[2];
                        while (s--) {
                            r = r.lastChild;
                        }
                        if (!aJ.support.tbody) {
                            var q = b0.test(v), d = u === "table" && !q ? r.firstChild && r.firstChild.childNodes : t[1] === "<table>" && !q ? r.childNodes : [];
            ...
            var s, r, q = aJ.cache, p = aJ.expando, o = aJ.event.special, n = aJ.support.deleteExpando;
    ...
    var b7 = /alpha\([^)]*\)/i, b5 = /opacity=([^)]*)/, b3 = /-([a-z])/ig, b1 = /([A-Z])/g, a9 = /^-?\d+(?:px)?$/i, a7 = /^-?\d/, a5 = {position: "absolute", visibility: "hidden", display: "block"}, a3 = ["Left", "Right"], a1 = ["Top", "Bottom"], aZ, aX, aW, aV = function (d, c) {
    ...
    aJ.fn.css = function (b, d) {
        ...
        return aJ.access(this, b, d, !0, function (f, h, g) {
    ...
    }, aJ.extend({cssHooks: {opacity: {get: function (e, d) {
                    if (d) {
                        var f = aZ(e, "opacity", "opacity");
                        return f === "" ? "1" : f;
                    }
                    return e.style.opacity;
                }}}, cssNumber: {zIndex: !0, fontWeight: !0, opacity: !0, zoom: !0, lineHeight: !0}, cssProps: {"float": aJ.support.cssFloat ? "cssFloat" : "styleFloat"}, style: function (r, q, p, o) {
            if (r && r.nodeType !== 3 && r.nodeType !== 8 && r.style) {
                var n, m = aJ.camelCase(q), l = r.style, d = aJ.cssHooks[m];
                q = aJ.cssProps[m] || m;
                if (p === aN) {
            ...
            var j, i = aJ.camelCase(l), d = aJ.cssHooks[i];
            l = aJ.cssProps[i] || i;
        ...
        aJ.cssHooks[c] = {get: function (b, i, h) {
                var g;
                if (i) {
    ...
    }), aJ.support.opacity || (aJ.cssHooks.opacity = {get: function (d, c) {
            return b5.test((c && d.currentStyle ? d.currentStyle.filter : d.style.filter) || "") ? parseFloat(RegExp.$1) / 100 + "" : c ? "1" : "";
        }, set: function (g, d) {
            var j = g.style;
            j.zoom = 1;
            var i = aJ.isNaN(d) ? "" : "alpha(opacity=" + d * 100 + ")", h = j.filter || "";
    ...
    var aT = /%20/g, aR = /\[\]$/, aQ = /\r?\n/g, aO = /#.*$/, aM = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, aK = /^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, aI = /(?:^file|^widget|\-extension):$/, aG = /^(?:GET|HEAD)$/, aE = /^\/\//, aC = /\?/, aA = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, cW = /^(?:select|textarea)/i, cV = /\s+/, cU = /([?&])_=[^&]*/, cT = /(^|\-)([a-z])/g, cS = function (e, d, f) {
        return d + f.toUpperCase();
    }, cR = /^([\w\+\.\-]+:)\/\/([^\/?#:]*)(?::(\d+))?/, cQ = aJ.fn.load, cP = {}, cO = {}, cN, cM;
    try {
        cN = aL.location.href;
    } catch (cL) {
        cN = aL.createElement("a"), cN.href = "", cN = cN.href;
    }
    cM = cR.exec(cN.toLowerCase()), aJ.fn.extend({load: function (b, n, m) {
            ...
            var d = this;
            aJ.ajax({url: b, type: j, dataType: "html", data: n, complete: function (f, e, g) {
            ...
            return this.map(function () {
                ...
                return f == null ? null : aJ.isArray(f) ? aJ.map(f, function (b, g) {
                    return{name: d.name, value: b.replace(aQ, "\r\n")};
        ...
        aJ[d] = function (c, j, i, h) {
            ...
            return aJ.ajax({type: d, url: c, data: j, success: i, dataType: h});
        };
    }), aJ.extend({getScript: function (b, d) {
            ...
            var R = aJ.ajaxSetup({}, S), Q = R.context || R, P = Q !== R && (Q.nodeType || Q instanceof aJ) ? aJ(Q) : aJ.event, O = aJ.Deferred(), N = aJ._Deferred(), M = R.statusCode || {}, L, K = {}, J, I, H, G, F, E = 0, D, C, B = {readyState: 0, setRequestHeader: function (e, c) {
            ...
            if (!R.hasContent) {
                ...
                if (R.cache === !1) {
                    var z = aJ.now(), d = R.url.replace(cU, "$1_=" + z);
        ...
        }}), aJ.extend({active: 0, lastModified: {}, etag: {}});
    var cF = aJ.now(), cD = /(\=)\?(&|$)|()\?\?()/i;
    aJ.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
        ...
        if (v.dataTypes[0] === "jsonp" || u.jsonpCallback || u.jsonp != null || v.jsonp !== !1 && (cD.test(v.url) || s && cD.test(v.data))) {
            var r, q = v.jsonpCallback = aJ.isFunction(v.jsonpCallback) ? v.jsonpCallback() : v.jsonpCallback, p = aP[q], o = v.url, n = v.data, d = "$1" + q + "$2", a = function () {
    ...
    }), aJ.ajaxSetup({accepts: {script: "text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"}, contents: {script: /javascript|ecmascript/}, converters: {"text script": function (b) {
                aJ.globalEval(b);
                return b;
    ...
    var cp = {}, cY = /^(?:toggle|show|hide)$/, cj = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, at, aq = [
        ["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"],
        ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"],
        ["opacity"]
    ];
    aJ.fn.extend({show: function (i, d, n) {
            var m, l;
            if (i || i === 0) {
            ...
            return this;
        }, _toggle: aJ.fn.toggle, toggle: function (f, d, h) {
            ...
            return this[h.queue === !1 ? "each" : "queue"](function () {
                var a = aJ.extend({}, h), o, n = this.nodeType === 1, m = n && aJ(this).is(":hidden"), l = this;
                for (o in g) {
                ...
                a.overflow != null && (this.style.overflow = "hidden"), a.curAnim = aJ.extend({}, g), aJ.each(g, function (u, t) {
                    ...
                    if (cY.test(t)) {
                        ...
                        var r = cj.exec(t), q = s.cur();
                        if (r) {
                            var p = parseFloat(r[2]), b = r[3] || (aJ.cssNumber[u] ? "" : "px");
            ...
            return this;
        }}), aJ.each({slideDown: ap("show", 1), slideUp: ap("hide", 1), slideToggle: ap("toggle", 1), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (d, c) {
        aJ.fn[d] = function (b, f, e) {
            return this.animate(c, b, f, e);
        };
    }), aJ.extend({speed: function (f, d, h) {
            var g = f && typeof f === "object" ? aJ.extend({}, f) : {complete: h || !h && d || aJ.isFunction(f) && f, duration: f, easing: h && d || d && !aJ.isFunction(d) && d};
        ...
        }}), aJ.fx.prototype = {update: function () {
            ...
            var l = this.options.specialEasing && this.options.specialEasing[this.prop], d = this.options.easing || (aJ.easing.swing ? "swing" : "linear");
    ...
    var ak = /^t(?:able|d|h)$/i, ai = /^(?:body|html)$/i;
    "getBoundingClientRect" in aL.documentElement ? aJ.fn.offset = function (B) {
        ...
        var v = x.body, u = ah(x), t = w.clientTop || v.clientTop || 0, s = w.clientLeft || v.clientLeft || 0, r = u.pageYOffset || aJ.support.boxModel && w.scrollTop || v.scrollTop, q = u.pageXOffset || aJ.support.boxModel && w.scrollLeft || v.scrollLeft, p = z.top + r - t, d = z.left + q - s;
        return{top: p, left: d};
        ...
        return{top: n, left: d};
    }, aJ.offset = {initialize: function () {
            var d = aL.body, c = aL.createElement("div"), p, o, n, m, l = parseFloat(aJ.css(d, "marginTop")) || 0, k = "<div style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;'><div></div></div><table style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>";
            ...
            var v = aJ(z), u = v.offset(), t = aJ.css(z, "top"), s = aJ.css(z, "left"), r = w === "absolute" && aJ.inArray("auto", [t, s]) > -1, q = {}, p = {}, o, d;
        ...
        }}, aJ.fn.extend({position: function () {
            if (!this[0]) {
                return null;
            }
            var f = this[0], d = this.offsetParent(), h = this.offset(), g = ai.test(d[0].nodeName) ? {top: 0, left: 0} : d.offset();
        ...
        aJ.fn["inner" + f] = function () {
            ...
            if (c === aN) {
                var j = aJ.css(l, d), e = parseFloat(j);
...
BrowserPlus = (typeof BrowserPlus != "undefined" && BrowserPlus) ? BrowserPlus : (function () {
    ...
    var l, k, j, n, d;
    return{initWhenAvailable: function (s, r) {
            setTimeout(function () {
                try {
                ...
                if (v.success) {
                    ...
                    for (var w = 0; w < v.value.length; w++) {
                        if (v.value[w].fullDesc) {
                            i({value: v.value[w].fullDesc});
                            u.push({service: v.value[w].service, version: v.value[w].version});
                        } else {
                            BrowserPlus.describeService({service: v.value[w].service, version: v.value[w].version}, i);
                            u = v.value;
                        }
                    }
                    v.value = u;
            ...
            if (!w) {
                r({success: false, error: "bp.unsupportedClient"});
                return;
            }
            if (q === "succeeded") {
                r({success: true});
            ...
            if (!s) {
                q = "uninitialized";
                r({success: false, error: "bp.notInstalled"});
                return;
            } else {
                o.push(r);
                var t = (function () {
                    ...
                    return function () {
                        var C = function (F) {
                            ...
                            if (!F.success && F.error === "bp.switchVersion") {
                                F = {success: false, error: "bp.notInstalled", verboseError: "BrowserPlus isn't installed, or couldn't be loaded"};
                            }
                        ...
                        try {
                            ...
                            var B = m();
                            var D = {success: false, error: "bp.notInstalled", verboseError: String(z)};
    ...
    function m() {
        var x = [
            ...
            {string: navigator.vendor, subString: "Google", identity: "Chrome"},
        ...
        var t = {Mac: {Firefox: "supported", Safari: "supported"}, Windows: {Explorer: {"8": "supported", "7": "supported", "6": "experimental"}, Safari: "supported", Firefox: "supported", Chrome: "supported"}};
        var v;
        ...
        return{browser: l, version: k, os: j, locale: n, supportLevel: d};
    }
})();
...
!function (bc, aU) {
    ...
    a7(aT, [], function () {
        var k = function (c) {
            ...
            var a = 0;
            return function (d) {
                var e = (new Date).getTime().toString(32), c;
                for (c = 0; 5 > c; c++) {
            ...
            var a = {t: 1099511627776, g: 1073741824, m: 1048576, k: 1024}, d;
            return c = /^([0-9]+)([mgk]?)$/.exec(c.toLowerCase().replace(/[^0-9mkg]/g, "")), d = c[2], c = +c[1], a.hasOwnProperty(d) && (c *= a[d]), c;
        };
        return{guid: p, typeOf: k, extend: w, each: g, isEmptyObj: j, inSeries: b, inArray: f, arrayDiff: q, arrayIntersect: x, toArray: v, trim: h, parseSizeStr: m};
    }), a7(be, [aT], function (b) {
        var a = {};
        return{addI18n: function (c) {
                return b.extend(a, c);
                ...
                var e = [].slice.call(arguments, 1), c = "";
        ...
        var d = "application/msword,doc dot,application/pdf,pdf,application/pgp-signature,pgp,application/postscript,ps ai eps,application/rtf,rtf,application/vnd.ms-excel,xls xlb,application/vnd.ms-powerpoint,ppt pps pot,application/zip,zip,application/x-shockwave-flash,swf swfl,application/vnd.openxmlformats-officedocument.wordprocessingml.document,docx,application/vnd.openxmlformats-officedocument.wordprocessingml.template,dotx,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,xlsx,application/vnd.openxmlformats-officedocument.presentationml.presentation,pptx,application/vnd.openxmlformats-officedocument.presentationml.template,potx,application/vnd.openxmlformats-officedocument.presentationml.slideshow,ppsx,application/x-javascript,js,application/json,json,audio/mpeg,mp3 mpga mpega mp2,audio/x-wav,wav,audio/mp4,m4a,audio/ogg,oga ogg,audio/aiff,aiff aif,audio/flac,flac,audio/aac,aac,audio/ac3,ac3,audio/x-ms-wma,wma,image/bmp,bmp,image/gif,gif,image/jpeg,jpg jpeg jpe,image/photoshop,psd,image/png,png,image/svg+xml,svg svgz,image/tiff,tiff tif,text/plain,asc txt text diff log,text/html,htm html xhtml,text/css,css,text/csv,csv,text/rtf,rtf,video/mpeg,mpeg mpg mpe m2v,video/quicktime,qt mov,video/mp4,mp4,video/x-m4v,m4v,video/x-flv,flv,video/x-ms-wmv,wmv,video/avi,avi,video/webm,webm,video/3gpp,3gpp 3gp,video/3gpp2,3g2,video/vnd.rn-realvideo,rv,video/ogg,ogv,video/x-matroska,mkv,application/vnd.oasis.opendocument.formula-template,otf,application/octet-stream,exe", a = {mimes: {}, extensions: {}, addMimeType: function (j) {
                ...
                var e = [], f = [];
                return"string" === c.typeOf(g) && (g = c.trim(g).split(/\s*,\s*/)), f = this.mimes2exts(g), e.push({title: b.translate("Files"), extensions: f.length ? f.join(",") : "*"}), e.mimes = g, e;
        ...
        var c = [
            ...
            var a = {define_property: function () {
                    return !1;
        ...
        }(), f = {can: b, browser: d(c), version: k(navigator.userAgent) || k(navigator.appVersion), OS: d(g), swf_url: "../flash/Moxie.swf", xap_url: "../silverlight/Moxie.xap", global_event_dispatcher: "moxie.core.EventTarget.instance.dispatchEvent"};
        return f;
    }), a7(bb, [bd], function (h) {
        var d = function (a) {
            ...
            function p(u) {
                var o, z, a = 0, s = 0;
                return u && (z = u.getBoundingClientRect(), o = "CSS1Compat" === y.compatMode ? y.documentElement : y.body, a = z.left + o.scrollLeft, s = z.top + o.scrollTop), {x: a, y: s};
            }

            var e = 0, l = 0, v, y = document, w, q;
            if (x = x, m = m || y.body, x && x.getBoundingClientRect && "IE" === h.browser && (!y.documentMode || y.documentMode < 8)) {
                return w = p(x), q = p(m), {x: w.x - q.x, y: w.y - q.y};
            }
        ...
        return{get: d, hasClass: k, addClass: c, removeClass: g, getStyle: j, getPos: b, getSize: f};
    }), a7(aZ, [aT], function (b) {
        function a(d, c) {
            var f;
            for (f in d) {
        ...
        return{RuntimeError: function () {
                ...
                var c = {NOT_INIT_ERR: 1, NOT_SUPPORTED_ERR: 9, JS_ERR: 4};
                ...
                return b.extend(c, {NOT_ALLOWED_ERR: 1}), c.prototype = Error.prototype, c;
            }(), ImageError: function () {
                function d(f) {
                    this.code = f, this.name = a(c, f), this.message = this.name + ": ImageError " + this.code;
                }

                var c = {WRONG_FORMAT: 1, MAX_RESOLUTION_ERR: 2};
                return b.extend(d, c), d.prototype = Error.prototype, d;
                ...
                var c = {NOT_FOUND_ERR: 1, SECURITY_ERR: 2, ABORT_ERR: 3, NOT_READABLE_ERR: 4, ENCODING_ERR: 5, NO_MODIFICATION_ALLOWED_ERR: 6, INVALID_STATE_ERR: 7, SYNTAX_ERR: 8};
                return b.extend(d, c), d.prototype = Error.prototype, d;
                ...
                return b.extend(c, {UNSPECIFIED_EVENT_TYPE_ERR: 0}), c.prototype = Error.prototype, c;
            }()};
    }), a7(a8, [aZ, aT], function (b, a) {
        function c() {
            var d = {};
            a.extend(this, {uid: null, init: function () {
                    ...
                    }), void 0) : (k = k.toLowerCase(), j = parseInt(j, 10) || 0, h = d[this.uid] && d[this.uid][k] || [], h.push({fn: g, priority: j, scope: l || this}), d[this.uid] || (d[this.uid] = {}), d[this.uid][k] = h, void 0);
                }, hasEventListener: function (f) {
                    return f ? !(!d[this.uid] || !d[this.uid][f]) : !!d[this.uid];
                }, removeEventListener: function (h, f) {
                    h = h.toLowerCase();
                    var g = d[this.uid] && d[this.uid][h], j;
                    if (g) {
                        if (f) {
        ...
        var c = function (f) {
            ...
            var w = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", g, k, C, E, D, B, v, A, y = 0, j = 0, x = "", t = [];
            if (!z) {
                return z;
            }
            z += "";
            ...
            var x = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e, k, D, G, E, C, w, B, A = 0, j = 0, y = "", v = [];
            if (!F) {
                return F;
            }
            do {
        ...
        return{utf8_encode: c, utf8_decode: b, atob: d, btoa: a};
    }), a7(a9, [aT, bb, a8], function (d, b, g) {
        function a(h, e, o, q, p) {
            function m(n, l) {
                var s = null, u = h && h.required_caps;
            ...
            var i = this, k, j = d.guid(e + "_");
            f[j] = this, o = d.extend({access_binary: !1, access_image_binary: !1, display_media: !1, do_cors: !1, drag_and_drop: !1, filter_by_extension: !0, resize_image: !1, report_upload_progress: !1, return_response_headers: !1, return_response_type: !1, return_status_code: !0, send_custom_headers: !1, select_file: !1, select_folder: !1, select_multiple: !0, send_binary_string: !1, send_browser_cookies: !0, send_multipart: !0, slice_blob: !1, stream_upload: !1, summon_file_dialog: !1, upload_filesize: !0, use_http_method: !0}, o), k = function () {
                var l = {};
                return{exec: function (u, v, s, t) {
                        return k[v] && (l[u] || (l[u] = {context: this, instance: new k[v]}), l[u].instance[s]) ? l[u].instance[s].apply(this, t) : void 0;
            ...
            }(), d.extend(this, {initialized: !1, uid: j, type: e, mode: null, shimid: j + "_container", clients: 0, options: h, can: function (l, v) {
                    var s = arguments[2] || o;
                    ...
                    return l || (r = this.options.container ? b.get(this.options.container) : document.body, l = document.createElement("div"), l.id = this.shimid, l.className = "moxie-shim moxie-shim-" + this.type, d.extend(l.style, {position: "absolute", top: "0px", left: "0px", width: "1px", height: "1px", overflow: "hidden"}), r.appendChild(l), r = null), l;
                }, getShim: function () {
                    return k;
        ...
        return a.order = "html5,flash,silverlight,html4", a.getRuntime = function (h) {
            ...
            return h ? {uid: h.uid, type: h.type, can: function () {
            ...
            var l, i = a.getConstructor(j), k;
            return i ? (l = new i({required_caps: h}), k = l.mode, l.destroy(), !!k) : !1;
        ...
        return function a() {
            var e;
            b.extend(this, {connectRuntime: function (h) {
                    function i(k) {
                        var l, j;
        ...
        function a(h, e) {
            function g(j, m, l) {
                var i, k = c[this.uid];
                return"string" === d.typeOf(k) && k.length ? (i = new a(null, {type: l, size: m - j}), i.detach(k.substr(j, i.size)), i) : null;
            }

            f.call(this), h && this.connectRuntime(h), e ? "string" === d.typeOf(e) && (e = {data: e}) : e = {}, d.extend(this, {uid: e.uid || d.guid("uid_"), ruid: h, size: e.size || 0, type: e.type || "", slice: function (j, i, k) {
        ...
        function a(f, h) {
            ...
            d.apply(this, arguments), c.extend(this, {type: e || "", name: j || c.guid("file_"), lastModifiedDate: h.lastModifiedDate || (new Date).toLocaleString()});
        }
            ...
            i = {accept: [
                    ...
                    n.convertEventPropsToHandlers(g), n.bind("RuntimeInit", function (o, c) {
                        n.ruid = c.uid, n.bind("Ready", function () {
                            ...
                            var u, x, r, w;
                            r = f.get(a.browse_button), w = f.get(c.shimid), r && (u = f.getPos(r, f.get(a.container)), x = f.getSize(r), w && j.extend(w.style, {top: u.y + "px", left: u.x + "px", width: x.w + "px", height: x.h + "px"})), w = r = null;
                        }), c.exec.call(n, "FileInput", "init", a);
                    }), n.connectRuntime(j.extend({}, a, {required_caps: {select_file: !0}}));
                }, disable: function (c) {
        ...
        function l(i) {
            var c = this, e;
            "string" == typeof i && (i = {drop_zone: i}), e = {accept: [
                    {title: h.translate("All Files"), extensions: "*"}
                ], required_caps: {drag_and_drop: !0}}, i = "object" == typeof i ? g.extend({}, e, i) : e, i.container = m.get(i.drop_zone) || document.body, "static" === m.getStyle(i.container, "position") && (i.container.style.position = "relative"), "string" == typeof i.accept && (i.accept = p.mimes2extList(i.accept)), d.call(c), g.extend(c, {uid: g.guid("uid_"), ruid: null, files: null, init: function () {
        ...
        function l() {
            ...
            var e = this, m;
            g.extend(this, {uid: g.guid("uid_"), readyState: l.EMPTY, result: null, error: null, readAsBinaryString: function (i) {
        ...
        var b = function (k) {
            for (var g = ["source", "scheme", "authority", "userInfo", "user", "pass", "host", "port", "relative", "path", "directory", "file", "query", "fragment"], m = g.length, f = {http: 80, https: 443}, j = {}, l = /^(?:([^:\/?#]+):)?(?:\/\/()(?:(?:()(?:([^:@]*):?([^:@]*))?@)?([^:\/?#]*)(?::(\d*))?))?()(?:(()(?:(?:[^?#\/]*\/)*)()(?:[^?#]*))(?:\\?([^#]*))?(?:#(.*))?)/, d = l.exec(k || ""); m--; ) {
                d[m] && (j[g[m]] = d[m]);
            }
        ...
        return{parseUrl: b, resolveUrl: a, hasSameOrigin: c};
        ...
        return function () {
            ...
            a.call(this), b.extend(this, {uid: b.guid("uid_"), readAsBinaryString: function (f) {
        ...
        function a() {
            var h, f = {}, g = "";
            b.extend(this, {append: function (j, k) {
                    var e = this, i = b.typeOf(k);
        ...
        function x() {
            ...
            function W(n) {
                ...
                function v(L) {
                    at.bind("LoadStart", function (M) {
                        ...
                        p && u.upload.dispatchEvent({type: "progress", lengthComputable: !1, total: M.total, loaded: M.loaded});
                    ...
                    }), L.exec.call(at, "XMLHttpRequest", "send", {url: bm, method: e, async: X, user: r, password: bl, headers: t, mimeType: c, encoding: bi, responseType: u.responseType, withCredentials: u.withCredentials, options: s}, n);
                }

                var u = this;
                l = (new Date).getTime(), at = new J, "string" == typeof s.required_caps && (s.required_caps = y.parseCaps(s.required_caps)), s.required_caps = G.extend({}, s.required_caps, {return_response_type: u.responseType}), n instanceof I && (s.required_caps.send_multipart = !0), i || (s.required_caps.do_cors = !0), s.ruid ? v(at.connectRuntime(s)) : (at.bind("RuntimeInit", function (M, L) {
                    v(L);
            ...
            var Q = this, o = {timeout: 0, readyState: x.UNSENT, withCredentials: !1, status: 0, statusText: "", responseType: "", responseXML: null, responseText: null, response: null}, X = !0, bm, e, t = {}, r, bl, bi = null, c = null, d = !1, h = !1, p = !1, Y = !1, m = !1, i = !1, l, Z, V = null, f = null, s = {}, at, a = "", K;
            G.extend(this, o, {uid: G.guid("uid_"), upload: new F, open: function (M, n, L, v, N) {
                    var g;
                    if (!M || !n) {
                    ...
                    return g = g.toLowerCase(), m || ~G.inArray(g, ["set-cookie", "set-cookie2"]) ? null : a && "" !== a && (K || (K = {}, G.each(a.split(/\r\n/), function (u) {
                        var v = u.split(/:\s+/);
                        2 === v.length && (v[0] = G.trim(v[0]), K[v[0].toLowerCase()] = {header: v[0], value: G.trim(v[1])});
                    ...
                    if (s = "string" === G.typeOf(g) ? {ruid: g} : g ? g : {}, this.convertEventPropsToHandlers(A), this.upload.convertEventPropsToHandlers(A), this.readyState !== x.OPENED || h) {
                        throw new k.DOMException(k.DOMException.INVALID_STATE_ERR);
                    }
                    if (v instanceof q) {
        ...
        var A = ["loadstart", "progress", "abort", "error", "load", "timeout", "loadend"], E = 1, b = 2;
        ...
        function c() {
            ...
            var q, p, m, g, k, j;
            f.call(this), d.extend(this, {uid: d.guid("uid_"), state: c.IDLE, result: null, transport: function (o, v, s) {
                    var i = this;
                    if (s = d.extend({chunk_size: 204798}, s), (q = s.chunk_size % 3) && (s.chunk_size += 3 - q), j = s.chunk_size, h.call(this), m = o, g = o.length, "string" === d.typeOf(s) || s.ruid) {
        ...
        return !!window.JSON && JSON.parse || function () {
            var t, j, m = {'"': '"', "\\": "\\", "/": "/", b: "\b", f: "\f", n: "\n", r: "\r", t: "	"}, b, h = function (a) {
                throw {name: "SyntaxError", message: a, at: t, text: b};
            }, x = function (a) {
        ...
        function x() {
            function d(c) {
                ...
                z.extend(this, {size: parseInt(c.size, 10), width: parseInt(c.width, 10), height: parseInt(c.height, 10), type: c.type}), "" === this.name && (this.name = c.name);
            }
                    ...
                    if (l instanceof x) {
                        ...
                        if (l instanceof v) {
                            ...
                            if (-1 !== z.inArray(c, ["blob", "file"])) {
                                ...
                                if ("string" === c) {
                                    /^data:[^;]*;base64,/.test(l) ? h.call(this, new v(null, {data: l}), arguments[1]) : f.apply(this, arguments);
                                } else {
            ...
            function a(l, o) {
                ...
                m.name = l.name || "", l.isDetached() ? (this.bind("RuntimeInit", function (n, i) {
                    c(i);
                }), o && "string" == typeof o.required_caps && (o.required_caps = j.parseCaps(o.required_caps)), this.connectRuntime(z.extend({required_caps: {access_image_binary: !0, resize_image: !0}}, o))) : c(this.connectRuntime(l.ruid));
            }
            ...
            C.call(this), z.extend(this, {uid: z.guid("uid_"), ruid: null, name: "", size: 0, width: 0, height: 0, type: "", meta: {}, clone: function () {
                        ...
                        if (D.can("use_data_uri_of", i.length)) {
                            ...
                            l.bind("TransportingComplete", function () {
                                N = t.connectRuntime(this.result.ruid), t.bind("Embedded", function () {
                                    z.extend(N.getShimContainer().style, {top: "0px", left: "0px", width: M.width + "px", height: M.height + "px"}), N = null;
                                }, 999), N.exec.call(t, "ImageView", "display", this.result.uid, u, I), M.destroy();
                            }), l.transport(y.atob(i.substring(i.indexOf("base64,") + 7)), K, z.extend({}, s, {required_caps: {display_media: !0}, runtime_order: "flash,silverlight", container: H}));
                        }
                    }

                    var t = this, M, K, G, J, s = arguments[1] || {}, u = this.width, I = this.height, N;
                    try {
                        if (!(H = E.get(H))) {
        ...
        function f(e) {
            var k = this, i = j.capTest, a = j.capTrue, l = g.extend({access_binary: i(window.FileReader || window.File && window.File.getAsDataURL), access_image_binary: function () {
                    return k.can("access_binary") && !!b.Image;
                }, display_media: i(c.can("create_canvas") || c.can("use_data_uri_over32kb")), do_cors: i(window.XMLHttpRequest && "withCredentials" in new XMLHttpRequest), drag_and_drop: i(function () {
                ...
                }()), return_response_headers: a, return_response_type: function (m) {
                    return"json" === m ? !0 : c.can("return_response_type", m);
                }, return_status_code: a, report_upload_progress: i(window.XMLHttpRequest && (new XMLHttpRequest).upload), resize_image: function () {
                ...
                }, send_binary_string: i(window.XMLHttpRequest && ((new XMLHttpRequest).sendAsBinary || window.Uint8Array && window.ArrayBuffer)), send_custom_headers: i(window.XMLHttpRequest), send_multipart: function () {
                    return !!(window.XMLHttpRequest && (new XMLHttpRequest).upload && window.FormData) || k.can("send_binary_string");
                }, slice_blob: i(window.File && (File.prototype.mozSlice || File.prototype.webkitSlice || File.prototype.slice)), stream_upload: function () {
                ...
                }()), upload_filesize: a}, arguments[2]);
            j.call(this, e, arguments[1] || h, l), g.extend(this, {init: function () {
                    this.trigger("Init");
                }, destroy: function (m) {
                    return function () {
                        m.call(k), m = k = null;
                    };
                }(this.destroy)}), g.extend(this.getShim(), b);
        }
        ...
        var c = {}, g = "moxie_" + h.guid(), j = function (p, i, n, m) {
            var q, e;
            ...
            }, p.attachEvent("on" + i, q)), p[g] || (p[g] = h.guid()), c.hasOwnProperty(p[g]) || (c[p[g]] = {}), e = c[p[g]], e.hasOwnProperty(i) || (e[i] = []), e[i].push({func: q, orig: n, key: m});
        }, b = function (l, r, p) {
            var e, m;
        ...
        function b() {
            ...
            d.extend(this, {init: function (x) {
                    ...
                    i = x, k = [], r = i.accept.mimes || f.extList2mimes(i.accept, v.can("filter_by_extension")), t = v.getShimContainer(), t.innerHTML = '<input id="' + v.uid + '" type="file" style="font-size:999px;opacity:0;"' + (i.multiple && v.can("select_multiple") ? "multiple" : "") + (i.directory && v.can("select_folder") ? "webkitdirectory directory" : "") + (r ? ' accept="' + r.join(",") + '"' : "") + " />", n = j.get(v.uid), d.extend(n.style, {position: "absolute", top: 0, left: 0, width: "100%", height: "100%"}), a = j.get(i.browse_button), v.can("summon_file_dialog") && ("static" === j.getStyle(a, "position") && (a.style.position = "relative"), o = parseInt(j.getStyle(a, "z-index"), 10) || 1, a.style.zIndex = o, t.style.zIndex = o - 1, c.addEvent(a, "click", function (m) {
                        ...
                        w.trigger("change");
                    }, w.trigger({type: "ready", async: !0}), t = null;
                }, getFiles: function () {
                    return k;
                }, disable: function (m) {
                    var l = this.getRuntime(), a;
                    (a = j.get(l.uid)) && (a.disabled = !!m);
                }, destroy: function () {
                    var a = this.getRuntime(), e = a.getShimContainer();
        ...
        function a() {
            ...
            var f, g = !1;
            d.extend(this, {read: function (j, i) {
                    var k = this;
        ...
        function g() {
            function o(w, s) {
                ...
                l = s.getBlob().getSource(), u = new window.FileReader, u.onload = function () {
                    s.append(s.getBlobName(), new d(null, {type: l.type, data: u.result})), self.send.call(x, w, s);
                }, u.readAsBinaryString(l);
            }

            function a() {
                return !window.XMLHttpRequest || "IE" === p.browser && p.version < 8 ? function () {
                    for (var s = ["Msxml2.XMLHTTP.6.0", "Microsoft.XMLHTTP"], l = 0;
                            l < s.length; l++) {
                        try {
            ...
            function r(s) {
                var l = s.responseXML, u = s.responseText;
            ...
            function i(x) {
                var u = "----moxieboundary" + (new Date).getTime(), y = "--", s = "\r\n", w = "", l = this.getRuntime();
            ...
            var n, c;
            q.extend(this, {send: function (z, w) {
                    var t = this, y = "Mozilla" === p.browser && p.version >= 4 && p.version < 7, x = "Android Browser" === p.browser, e = !1;
                    ...
                    n.upload ? (z.withCredentials && (n.withCredentials = !0), n.addEventListener("load", function (s) {
                        ...
                        t.trigger({type: "UploadProgress", loaded: s.loaded, total: s.total});
                        ...
                        switch (n.readyState) {
                            ...
                            case 3:
                                ...
                                t.trigger({type: "progress", lengthComputable: !!B, total: parseInt(B, 10), loaded: s});
                                break;
                            case 4:
                                n.onreadystatechange = function () {
                                }, 0 === n.status ? t.trigger("error") : t.trigger("load");
                        }
                    ...
                    try {
                        switch (y) {
                            case"blob":
                                var u = new b(w.uid, n.response), z = n.getResponseHeader("Content-Disposition");
                                if (z) {
            ...
            if (f = new b, f.init(h), 65496 === f.SHORT(0)) {
                for (g = 2; g <= h.length; ) {
                    if (c = f.SHORT(g), c >= 65488 && 65495 >= c) {
                        ...
                        e = f.SHORT(g + 2) + 2, c >= 65505 && 65519 >= c && d.push({hex: c, name: "APP" + (15 & c), start: g, length: e, segment: f.SEGMENT(g, e)}), g += e;
                    }
                }
                return f.init(null), {headers: d, restore: function (j) {
                        var i, k;
        ...
        return function a() {
            function g(B, v) {
                var x = e.SHORT(B), l, t, E, D, C, A, q, y, w = [], z = {};
                for (l = 0; x > l; l++) {
        ...
        function f(h) {
            function n() {
                for (var o = 0, l, p; o <= q.length; ) {
                    if (l = m.SHORT(o += 2), l >= 65472 && 65475 >= l) {
                        return o += 5, {height: m.SHORT(o), width: m.SHORT(o += 2)};
                    }
                    p = m.SHORT(o += 2), o += p - 2;
                }
                return null;
            ...
            i = new g(h), k = new c, e = !!k.init(i.get("app1")[0]), j = n.call(this), d.extend(this, {type: "image/jpeg", size: q.length, width: j && j.width || 0, height: j && j.height || 0, setExif: function (l, o) {
                    ...
                    r.call(this);
                }}), e && (this.meta = {tiff: k.TIFF(), exif: k.EXIF(), gps: k.GPS()});
        }
        ...
        function a(h) {
            function e() {
                var l, i;
                return l = m.call(this, 8), "IHDR" == l.type ? (i = l.start, {width: n.LONG(i), height: n.LONG(i += 4)}) : null;
            }
            ...
            function m(s) {
                var o, u, l, q;
                return o = n.LONG(s), u = n.STRING(s += 4, 4), l = s += 4, q = n.LONG(s + o), {length: o, type: u, start: l, CRC: q};
            }

            var p, n, k, g, j;
            p = h, n = new d, n.init(p), function () {
                var o = 0, q = 0, l = [35152, 20039, 3338, 6666];
                for (q = 0; q < l.length; q++, o += 2) {
                    if (l[q] != n.SHORT(o)) {
                        throw new c.ImageError(c.ImageError.WRONG_FORMAT);
                    }
                }
            }(), j = e.call(this), b.extend(this, {type: "image/png", size: p.length, width: j.width, height: j.height, purge: function () {
                    f.call(this);
                }}), f.call(this);
        }
        ...
        return function (f) {
            ...
            e = function () {
                ...
                throw new b.ImageError(b.ImageError.WRONG_FORMAT);
            }(), c.extend(this, {type: "", size: 0, width: 0, height: 0, setExif: function () {
        ...
        function b(M, I, C) {
            var F = M.naturalWidth, P = M.naturalHeight, B = C.width, z = C.height, O = C.x || 0, H = C.y || 0, N = I.getContext("2d");
            a(M) && (F /= 2, P /= 2);
            var L = 1024, D = document.createElement("canvas");
            D.width = D.height = L;
            for (var J = D.getContext("2d"), G = c(M, F, P), K = 0; P > K; ) {
                for (var t = K + L > P ? P - K : L, k = 0; F > k; ) {
                    var A = k + L > F ? F - k : L;
                    J.clearRect(0, 0, L, L), J.drawImage(M, -k, -K);
                    var Q = k * B / F + O << 0, j = Math.ceil(A * B / F), q = K * z / P / G + H << 0, n = Math.ceil(t * z / P / G);
        ...
        function a(h) {
            var f = h.naturalWidth, j = h.naturalHeight;
            if (f * j > 1048576) {
        ...
        return{isSubsampled: a, renderTo: b};
        ...
        function j() {
            ...
            function q(y, v, I, c, x, E) {
                if ("iOS" === l.OS) {
                    k.renderTo(y, v, {width: x, height: E, x: I, y: c});
                } else {
            ...
            var G = this, B, H, F, o, D, C = !1, A = !0;
            m.extend(this, {loadFromBlob: function (x) {
                    var v = this, c = v.getRuntime(), w = arguments.length > 1 ? arguments[1] : !0;
                    ...
                    this.meta = v.meta, D = new b(null, {name: v.name, size: v.size, type: v.type}), u.call(this, c ? o = v.getAsBinaryString() : v.getAsDataURL());
                }, getInfo: function () {
                    var c = this.getRuntime(), e;
                    return !H && o && c.can("access_image_binary") && (H = new d(o)), e = {width: t().width || 0, height: t().height || 0, type: D.type || p.getFileMime(D.name), size: o && o.length || D.size || 0, name: D.name || "", meta: H && H.meta || this.meta || {}};
                }, downsize: function () {
                    a.apply(this, arguments);
                }, getAsCanvas: function () {
                    return F && (F.id = this.uid + "_canvas"), F;
                }, getAsBlob: function (v, c) {
                    return v !== this.type && a.call(this, this.width, this.height, !1), new b(null, {type: v, data: G.getAsBinaryString.call(this, v, c)});
                    ...
                    if ("image/jpeg" !== w) {
                        ...
                        o = z(x), H && (o = H.stripHeaders(o), A && (H.meta && H.meta.exif && H.setExif({PixelXDimension: this.width, PixelYDimension: this.height}), o = H.writeHeaders(o)), H.purge(), H = null);
                    }
                    return C = !1, o;
                }, destroy: function () {
        ...
        function h(i) {
            var m = this, e;
            i = g.extend({swf_url: k.swf_url}, i), b.call(this, i, l, {access_binary: function (a) {
                    return a && "browser" === m.mode;
                }, access_image_binary: function (a) {
                    return a && "browser" === m.mode;
                }, display_media: b.capTrue, do_cors: b.capTrue, drag_and_drop: !1, report_upload_progress: function () {
                    return"client" === m.mode;
                }, resize_image: b.capTrue, return_response_headers: !1, return_response_type: function (a) {
                ...
                }, select_file: b.capTrue, select_multiple: b.capTrue, send_binary_string: function (a) {
                    return a && "browser" === m.mode;
                }, send_browser_cookies: function (a) {
                    return a && "browser" === m.mode;
                }, send_custom_headers: function (a) {
                    return a && "browser" === m.mode;
                }, send_multipart: b.capTrue, slice_blob: b.capTrue, stream_upload: function (a) {
                    return a && "browser" === m.mode;
                }, summon_file_dialog: !1, upload_filesize: function (a) {
                ...
                }}, "client"), c() < 10 && (this.mode = !1), g.extend(this, {getShim: function () {
        ...
        var a = {init: function (c) {
                this.getRuntime().shimExec.call(this, "FileInput", "init", {name: c.name, accept: c.accept, multiple: c.multiple}), this.trigger("ready");
            }};
        ...
        var a = "", c = {read: function (i, g) {
                var h = this, j = h.getRuntime();
        ...
        var j = {send: function (p, n) {
                ...
                function v(r, i) {
                    ...
                    s.bind("TransportingComplete", function () {
                        i(this.result);
                    }), s.transport(r.getSource(), r.type, {ruid: m.uid});
                }

                var t = this, m = t.getRuntime();
        ...
        var f = {loadFromBlob: function (l) {
                ...
                var k = this.getRuntime(), i = k.shimExec.call(this, "Image", "getAsBlob", j, h);
                return i ? new a(k.uid, i) : null;
            }, getAsDataURL: function () {
                var i = this.getRuntime(), h = i.Image.getAsBlob.apply(this, arguments), j;
                return h ? (j = new c, j.readAsDataURL(h)) : null;
            }};
        return d.Image = f;
    }), a7(aY, [aT, bd, bb, aZ, a9], function (g, k, d, f, b) {
        function c(x) {
            var C = !1, q = null, w, m, p, A, D, B = 0;
            try {
                try {
        ...
        function h(i) {
            var m = this, e;
            i = g.extend({xap_url: k.xap_url}, i), b.call(this, i, l, {access_binary: b.capTrue, access_image_binary: b.capTrue, display_media: b.capTrue, do_cors: b.capTrue, drag_and_drop: !1, report_upload_progress: b.capTrue, resize_image: b.capTrue, return_response_headers: function (a) {
                    return a && "client" === m.mode;
                }, return_response_type: b.capTrue, return_status_code: function (a) {
                    return"client" === m.mode || !g.arrayDiff(a, [200, 404]);
                }, select_file: b.capTrue, select_multiple: b.capTrue, send_binary_string: b.capTrue, send_browser_cookies: function (a) {
                    return a && "browser" === m.mode;
                }, send_custom_headers: function (a) {
                    return a && "client" === m.mode;
                }, send_multipart: b.capTrue, slice_blob: b.capTrue, stream_upload: !0, summon_file_dialog: !1, upload_filesize: b.capTrue, use_http_method: function (a) {
                ...
                }}), c("2.0.31005.0") && "Opera" !== k.browser || (this.mode = !1), g.extend(this, {getShim: function () {
        ...
        function f(e) {
            var k = this, i = j.capTest, a = j.capTrue;
            j.call(this, e, h, {access_binary: i(window.FileReader || window.File && File.getAsDataURL), access_image_binary: !1, display_media: i(b.Image && (c.can("create_canvas") || c.can("use_data_uri_over32kb"))), do_cors: !1, drag_and_drop: !1, filter_by_extension: i(function () {
                    return"Chrome" === c.browser && c.version >= 28 || "IE" === c.browser && c.version >= 10;
                }()), resize_image: function () {
                    return b.Image && k.can("access_binary") && c.can("create_canvas");
                }, report_upload_progress: !1, return_response_headers: !1, return_response_type: function (l) {
                    ...
                    return"Firefox" === c.browser && c.version >= 4 || "Opera" === c.browser && c.version >= 12 || "IE" === c.browser && c.version >= 10 || !!~g.inArray(c.browser, ["Chrome", "Safari"]);
                }()), upload_filesize: a, use_http_method: function (l) {
                    return !g.arrayDiff(l, ["GET", "POST"]);
                }}), g.extend(this, {init: function () {
                    this.trigger("Init");
                }, destroy: function (l) {
                    return function () {
                        l.call(k), l = k = null;
        ...
        function b() {
            function m() {
                ...
                }, s.uid)), i = q, v = u = t = null, s.trigger({type: "ready", async: !0});
            }

            var i, l = [], k = [], n;
            d.extend(this, {init: function (p) {
                    var r = this, e = r.getRuntime(), q;
                    n = p, k = p.accept.mimes || f.extList2mimes(p.accept, e.can("filter_by_extension")), q = e.getShimContainer(), function () {
                        var s, o, a;
                    ...
                    var o = this.getRuntime(), a = o.getShimContainer();
        ...
        function j() {
            ...
            var o, a, n;
            m.extend(this, {send: function (x, s) {
                    function c() {
                        var v = e.getShimContainer() || document.body, u = document.createElement("div");
                        u.innerHTML = '<iframe id="' + r + '_iframe" name="' + r + '_iframe" src="javascript:&quot;&quot;" style="display:none"></iframe>', n = u.firstChild, v.appendChild(n), d.addEvent(n, "load", function () {
                            var A;
                            try {
                                A = n.contentWindow.document || n.contentDocument || window.frames[n.id].document, /^4\d{2}\s/.test(A.title) && A.getElementsByTagName("address").length ? o = A.title.replace(/^(\d+).*$/, "$1") : (o = 200, a = m.trim(A.body.innerHTML), q.trigger({type: "progress", loaded: a.length, total: a.length}), z && q.trigger({type: "uploadprogress", loaded: z.size || 1025, total: z.size || 1025}));
                            } catch (y) {
                    ...
                    var q = this, e = q.getRuntime(), r, w, t, z;
                    ...
                    s instanceof p && s.each(function (v, y) {
                        if (v instanceof k) {
                            ...
                            m.extend(u, {type: "hidden", name: y, value: v}), w.appendChild(u);
                        }
...
(function () {
    var b = {}, a = moxie.core.utils.Basic.inArray;
    return function c(f) {
        var d, e;
        for (d in f) {
...
(function (f, b, h) {
    ...
    var d = f.setTimeout, a = {}, g = {VERSION: "2.0.0beta", STOPPED: 1, STARTED: 2, QUEUED: 1, UPLOADING: 2, FAILED: 4, DONE: 5, GENERIC_ERROR: -100, HTTP_ERROR: -200, IO_ERROR: -300, SECURITY_ERROR: -400, INIT_ERROR: -500, FILE_SIZE_ERROR: -600, FILE_EXTENSION_ERROR: -601, FILE_DUPLICATE_ERROR: -602, IMAGE_FORMAT_ERROR: -700, IMAGE_MEMORY_ERROR: -701, IMAGE_DIMENSIONS_ERROR: -702, mimeTypes: b.mimes, ua: b.ua, typeOf: b.typeOf, extend: b.extend, guid: b.guid, each: b.each, getPos: b.getPos, getSize: b.getSize, xmlEncode: function (j) {
            var i = {"<": "lt", ">": "gt", "&": "amp", '"': "quot", "'": "#39"}, k = /[<>&\"\']/g;
            return j ? ("" + j).replace(k, function (l) {
                return i[l] ? "&" + i[l] + ";" : l;
            }) : j;
        }, toArray: b.toArray, inArray: b.inArray, addI18n: b.addI18n, translate: b.translate, isEmptyObj: b.isEmptyObj, hasClass: b.hasClass, addClass: b.addClass, removeClass: b.removeClass, getStyle: b.getStyle, addEvent: b.addEvent, removeEvent: b.removeEvent, removeAllEvents: b.removeAllEvents, cleanName: function (j) {
            var i, k;
        ...
        }, parseSize: b.parseSizeStr, predictRuntime: function (k, i) {
            var l, j;
    ...
    g.addFileFilter("mime_types", function () {
        ...
        return function (m, e, l) {
            ...
            i.test(e.name) ? l(!0) : (this.trigger("Error", {code: g.FILE_EXTENSION_ERROR, message: g.translate("File extension error."), file: e}), l(!1));
        };
    }()), g.addFileFilter("max_file_size", function (k, i, l) {
        var j;
        i.size !== j && k && i.size > k ? (this.trigger("Error", {code: g.FILE_SIZE_ERROR, message: g.translate("File size error."), file: i}), l(!1)) : l(!0);
        ...
        if (k) {
            ...
            while (j--) {
                if (i.name === this.files[j].name && i.size === this.files[j].size) {
                    this.trigger("Error", {code: g.FILE_DUPLICATE_ERROR, message: g.translate("Duplicate file error."), file: i}), l(!1);
                    return;
                }
            }
        }
        ...
        function z() {
            var m = this, l = 0, e = {accept: r.filters.mime_types, runtime_order: r.runtimes, required_caps: q, swf_url: r.flash_swf_url, xap_url: r.silverlight_xap_url};
            g.each(r.runtimes.split(/\s*,\s*/), function (p) {
                r[p] && (e[p] = r[p]);
            }), b.inSeries([function (p) {
                    r.browse_button ? (i = new b.FileInput(g.extend({}, e, {name: r.file_data_name, multiple: r.multi_selection, container: r.container, browse_button: r.browse_button})), i.onready = function () {
                        var u = b.Runtime.getInfo(this.ruid);
                        b.extend(m.features, {chunks: u.can("slice_blob"), multipart: u.can("send_multipart"), multi_selection: u.can("select_multiple")}), l++, p();
                    }, i.onchange = function () {
                    ...
                    r.drop_element ? (s = new b.FileDrop(g.extend({}, e, {drop_zone: r.drop_element})), s.onready = function () {
                        var u = b.Runtime.getInfo(this.ruid);
                ...
                typeof r.init == "function" ? r.init(m) : g.each(r.init, function (u, p) {
                    m.bind(p, u);
                }), l ? m.trigger("PostInit") : m.trigger("Error", {code: g.INIT_ERROR, message: g.translate("Init error.")});
            });
        }
        ...
        t = new g.QueueProgress, r = g.extend({runtimes: b.Runtime.order, max_retries: 0, multipart: !0, multi_selection: !0, file_data_name: "file", flash_swf_url: "js/Moxie.swf", silverlight_xap_url: "js/Moxie.xap", send_chunk_number: !0}, r), r.resize && (r.resize = g.extend({preserve_headers: !0, crop: !1}, r.resize)), g.typeOf(r.filters) === "array" && (r.filters = {mime_types: r.filters}), r.filters = g.extend({mime_types: [], prevent_duplicates: !!r.prevent_duplicates, max_file_size: r.max_file_size}, r.filters), r.filters.max_file_size = g.parseSize(r.filters.max_file_size) || 0, r.chunk_size = g.parseSize(r.chunk_size) || 0, r.required_features = q = c(g.extend({}, r)), g.extend(this, {id: g.guid(), state: g.STOPPED, features: {}, runtime: b.Runtime.thatCan(q, r.runtimes), files: D, settings: r, total: t, init: function () {
                ...
                if (!r.browse_button || !r.url) {
                    this.trigger("Error", {code: g.INIT_ERROR, message: g.translate("Init error.")});
                    return;
                }
                e.bind("FilesAdded", function (m, l) {
                    ...
                    var u = l.name.match(/\.([^.]+)$/), m = "part";
                    u && (m = u[1]), l.target_name = l.id + "." + m;
                }), e.bind("UploadFile", function (v, y) {
                    function m() {
                        w-- > 0 ? d(G, 1) : (y.loaded = E, v.trigger("Error", {code: g.HTTP_ERROR, message: g.translate("HTTP Error."), file: y, response: C.responseText, status: C.status, responseHeaders: C.getAllResponseHeaders()}));
                    }
                    ...
                    function G() {
                        ...
                        L = {name: y.target_name || y.name}, I && J.chunks && H.size > I ? (M = Math.min(I, H.size - E), u = H.slice(E, E + M)) : (M = H.size, u = H), I && J.chunks && (r.send_chunk_number ? (L.chunk = Math.ceil(E / I), L.chunks = Math.ceil(H.size / I)) : (L.offset = E, L.total = H.size)), C = new b.XMLHttpRequest, C.upload && (C.upload.onprogress = function (l) {
                ...
                }), e.trigger("Init", {runtime: this.runtime}), z.call(this);
            }, refresh: function () {
                ...
                var m;
                p = p.toLowerCase(), m = A[p] || [], m.push({func: l, scope: u || this}), A[p] = m;
            }, unbind: function (u) {
                u = u.toLowerCase();
                var m = A[u], p, l = arguments[1];
                if (m) {
                    if (l !== h) {
        ...
        function j(e) {
            g.extend(this, {id: g.guid(), name: e.name || e.fileName, type: e.type || "", size: e.size || e.fileSize, origSize: e.size || e.fileSize, loaded: 0, percent: 0, status: g.QUEUED, lastModifiedDate: e.lastModifiedDate || (new Date).toLocaleString(), getNative: function () {
...
(function (c) {
    ...
    c.fn.pluploadQueue = function (e) {
        return e ? (this.each(function () {
            ...
            function q() {
                var h = c("ul.plupload_filelist", p).html(""), l = 0, f;
            ...
            var k, p, j, g;
            p = c(this), j = p.attr("id"), j || (j = plupload.guid(), p.attr("id", j)), g = p.html(), b(j, p), k = new plupload.Uploader(c.extend({dragdrop: !0, browse_button: j + "_browse", container: j}, e)), a[j] = k, k.bind("UploadFile", function (f, h) {
...
jQuery(function () {
    window["doksoftPlupload2"] = jQuery("#plupload2_doksoft_image").pluploadQueue({runtimes: "html5,html4,flash,silverlight,browserplus,gears", url: window["doksoft_image_doksoftUploaderUrl"], unique_names: true, filters: [
            {title: "Image files", extensions: "jpg,jpeg,gif,png,bmp,tif,tiff"},
            {title: "Zip files", extensions: "zip,rar,gz,tar"}
        ], flash_swf_url: window["doksoft_image_ckeditorPluginPath"] + "plupload2/plupload.flash.swf", silverlight_xap_url: window["doksoft_image_ckeditorPluginPath"] + "plupload2/plupload.silverlight.xap", init: {FileUploaded: function (c, b, a) {

                if (a.response.substr(0, 1) == "!") {
                    c.trigger("Error", {code: 500, message: a.response.substr(1), details: "", file: b});
                    $(".plupload_buttons").show();
                    alert(a.response.substr(1));
                } else {
                    if (window["doksoft_image_doksoftUploadedFiles"][window["doksoft_image_doksoftUploadedFiles"].length - 1] != a.response) {
                        window["doksoft_image_doksoftUploadedFiles"].push(a.response);
                    }
                }
            }, }});
