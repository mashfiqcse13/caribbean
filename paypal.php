...
if (isset($_SESSION['talent_id']) && $_SESSION['talent_id'] != '') {
    $uid = $_SESSION['talent_id'];
...
switch ($_GET['action']) {
    ...
    case 'ipn':          // Paypal is calling page for IPN validation...
        ...
        if ($p->validate_ipn()) {
            ...
            $subject = "Congratulations. Payment Successful for " . $row_p['product_name'] . " ";



            SendEMail($to_email, $subject, $message1, $from_email);
            ...
            SendEMail($to_email1, $subject1, $message2, $from_email1);
            ...
            SendEMail($to_email2, $subject2, $message3, $from_email2);
        }
        break;
}
?>